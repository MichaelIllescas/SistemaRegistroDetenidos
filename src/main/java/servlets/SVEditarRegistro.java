...
public class SVEditarRegistro extends HttpServlet {
   ...
   Controladora controladora =new Controladora();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Date fecha= Utilitaria.buscarDetenidoPorId(registroAeditar.getCausa().getDetenidos(), idDetenido).getFechaNacimiento();
    
        System.out.println(Utilitaria.convertirDateAinputDate(fecha));
    }
