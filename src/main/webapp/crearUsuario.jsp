                    ...
                    <div class="col-md-6 offset-md-3 ">
                        ...
                        <div class="form-group ">
                            <div class="col-sm-12 mx-auto mb-3">
                                ...
                                <input name="nomusu" type="text" class="form-control form-control-lg " id="nomusu" placeholder="Nombre de Usuario" required>
                            </div>
                            <div class="col-sm-12 mx-auto mb-3">
                                <label for="contras">* Ingrese una Clave</label>
                                <input type="password" class="form-control form-control-lg " id="contras" placeholder="Contraseña" name="contras" required>
                            </div>
                        </div>        
                        <div class="form-group">
                            <div class="col-sm-12 mx-auto mb-3">
                                <label for="rol">Selecciona un Rol</label>
                                <select id="miListaDesplegable" name="rol" class="form-control form-control-lg form-select rounded-1 " style="font-size: 1.2em; height: 50px;" required>
                            ...
                            <div class="form-group col-sm-12 mx-auto mb-5 ">
                                ...
                                <select id="miListaDesplegable" class="form-control form-control-lg form-select" name="policia" required>
