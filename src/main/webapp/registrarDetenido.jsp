    ...
    <div class="accordion-item gradiente-azul-oscuro shadow-lg">
        ...
        <div id="collapseThree" class="accordion-collapse collapse fade" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                ...
                <div class="col-sm-12 mx-auto mb-3">
                    <label for="fechaEgreso">Fecha de Ingreso: </label>
                    <input name="fechaEgreso" id="fechaEgreso" type="date" class="form-control form-control-lg" required>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="collapseDte" class="accordion-collapse collapse fade" data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <div class="col-sm-12 mx-auto mb-3">
                    ...
                    <input name="nombreDte" type="text" class="form-control form-control-lg" id="nombre" required>
                </div>
                <div class="col-sm-12 mx-auto mb-3">
                    <label for="apellidoDte">Apellido:</label>
                    <input name="apellidoDte" type="text" class="form-control form-control-lg" id="apellido" required>
                </div>
                <div class="col-sm-12 mx-auto mb-3">
                    <label for="dniDte">D.N.I. / Documento:</label>
                    <input name="dniDte" type="text" class="form-control form-control-lg" id="dni" required>
                </div>
                <div class="col-sm-12 mx-auto mb-3">
                    <label for="direccionDte">Direccion:</label>
                    <input name="direccionDte" type="text" class="form-control form-control-lg" id="direccion" required>
                </div>
                <div class="col-sm-12 mx-auto mb-3">
                    <label for="telefonoDte">Telefono:</label>
                    <input name="telefonoDte" type="text" class="form-control form-control-lg" id="telefono" required>
                </div>
                <div class="col-sm-12 mx-auto mb-3">
                    <label for="fechaNacDte">Fecha de Nacimiento:</label>
                    <input name="fechaNacDte" id="fechaNac" type="date" class="form-control form-control-lg" required>
                </div>
            </div>
        </div>
    </div>
